...
<html lang="en">
    ...
    <body class=" login" style="background-image:url({{ asset('img/login/bg1.jpg') }}); background-size: cover;">
        <!-- BEGIN LOGO -->
        <div class="">
        ...
        <div class="content" style="margin-top:200px;">
            ...
            @endif       
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{ url('admin') }}" method="post">{{ csrf_field() }}
