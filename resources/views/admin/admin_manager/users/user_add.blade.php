                    ...
                    <form class="form-horizontal" method="post" action="{{ url('admin/users/create') }}" name="add_user" id="add_user">{{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_rate" id="user_rate" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="control-label col-md-3">Education</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_education" id="user_education" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="control-label col-md-3">Citizenship</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_citizenship" id="user_citizenship" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="control-label col-md-3">Supervisor</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_supervisor" id="user_supervisor" />
                                </div>
                            </div>
                            <div class="form-group has-success">
