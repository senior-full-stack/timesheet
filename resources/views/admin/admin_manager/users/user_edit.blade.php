                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/admin/users/edit/'.$userDetails->id) }}" novalidate="novalidate">{{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_lastname" value="{{ $userDetails->lastname }}" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <select style='width: 100%;height: 100%;' class='department' name='department'>
                                        ...
                                        <option value="{{ $department->id }}" {{ $department->id==$userDetails->departmentid ? 'selected' : '' }}>{{ $department->type }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_password" value="{{ $userDetails->password }}" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="control-label col-md-3">Rates</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="user_rate" value="{{ $userDetails->rates }}" />
                                </div>
                            </div>
                            <div class="form-group has-success">
