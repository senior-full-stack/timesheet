...
<input type="hidden" id="user_id" value="<?php echo e(session('user_id')); ?>" />
<br><br><br>
<!-- END PAGE HEADER-->
<div class="row">
    <div class="col-md-12">
...
<script>
    $(document).ready(function(){
        $('#calendar_view').fullCalendar({
            ...
            events : [
                <?php $__currentLoopData = $calendar_view_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {
                    title : '<?php echo e($task->project_name); ?>',
                    start : '<?php echo e($task->start); ?>'
                },
...
<?php echo $__env->make('layouts.front_layouts.front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\timesheet\resources\views/calendar_view.blade.php ENDPATH**/ ?>