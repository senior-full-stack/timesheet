...
<html lang="en">
    ...
    <body class=" login" style="background-image:url(<?php echo e(asset('img/login/bg1.jpg')); ?>); background-size: cover;">
        ...
        <div class="content" style="margin-top:200px;">
            ...
            <?php endif; ?>       
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo e(url('home')); ?>" method="post"><?php echo e(csrf_field()); ?>
...
</html><?php /**PATH E:\Laravel\timesheet\resources\views/user_login.blade.php ENDPATH**/ ?>