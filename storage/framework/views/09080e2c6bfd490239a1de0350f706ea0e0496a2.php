...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <form method="post" action="<?php echo e(url('admin/accounting/project_budget_store')); ?>"><?php echo e(csrf_field()); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <div id="projectbudgetContent" data-url=<?php echo e(route('projectbudget.content')); ?>></div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin_layouts.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\timesheet\resources\views/admin/accounting/project_budget.blade.php ENDPATH**/ ?>