...
<div class="page-container" id="timesheet_form">  
    ...
    <div class="page-content" >
        <form method="post" action="<?php echo e(url('timesheet_store')); ?>" name="timesheet" id="timesheet"><?php echo e(csrf_field()); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-2" style="margin-left:70px;">
                    <p>
                        ...
                        <select class="week_sel" name="week_sel" id="week_sel">                       
                            <?php $__currentLoopData = $week_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item); ?>"  <?php echo e(($item == $week_date) ? 'selected' : ''); ?>>
                                    <?php echo e($item); ?>
                ...
                <div class="col-md-9">
                    <div id="timesheetContent" data-url=<?php echo e(route('timesheet.content')); ?>></div>
                    <br>
                </div>
...
<?php echo $__env->make('layouts.front_layouts.front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\timesheet\resources\views/timesheet.blade.php ENDPATH**/ ?>